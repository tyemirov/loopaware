...
(function () {
  ...
  function resolveGoogleSigninTarget(headerHost) {
    ...
    var interactiveTarget = container.querySelector('button:not([data-mpr-google-wrapper="true"])');
    if (interactiveTarget) {
      return interactiveTarget;
    }
    interactiveTarget = container.querySelector('[role="button"]');
    if (interactiveTarget) {
      return interactiveTarget;
    }
    interactiveTarget = container.querySelector('[data-mpr-google-target="true"]');
    if (interactiveTarget) {
      return interactiveTarget;
    }
