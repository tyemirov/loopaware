...
MOBILE_IOS_DEVELOPMENT_TEAM ?= $(APPLE_TEAM_ID)
...
build-ios: mobile-check
	...
	@LOOPAWARE_MOBILE_IOS_BUNDLE_IDENTIFIER="$(MOBILE_IOS_BUNDLE_IDENTIFIER)" LOOPAWARE_MOBILE_GOOGLE_IOS_REDIRECT_URI="$(MOBILE_GOOGLE_IOS_REDIRECT_URI)" LOOPAWARE_MOBILE_IOS_BUILD_NUMBER="$(MOBILE_IOS_BUILD_NUMBER)" MOBILE_IOS_DEVELOPMENT_TEAM="$(MOBILE_IOS_DEVELOPMENT_TEAM)" node "$(MOBILE_IOS_ARCHIVE_SCRIPT)" --mobile-dir "$(MOBILE_DIR)" --build-dir "$(MOBILE_IOS_BUILD_DIR)" $(MOBILE_IOS_ARCHIVE_ARGS)
...
mobile-android-bundle: mobile-check
	...
	@ANDROID_HOME="$(ANDROID_HOME)" ANDROID_SDK_ROOT="$(ANDROID_SDK_ROOT)" ANDROID_STUDIO_JAVA_HOME="$(ANDROID_STUDIO_JAVA_HOME)" LOOPAWARE_MOBILE_ANDROID_PACKAGE="$(MOBILE_ANDROID_PACKAGE)" LOOPAWARE_MOBILE_ANDROID_VERSION_CODE="$(MOBILE_ANDROID_VERSION_CODE)" node "$(MOBILE_ANDROID_BUNDLE_SCRIPT)" --mobile-dir "$(MOBILE_DIR)" --android-sdk-root "$(ANDROID_SDK_ROOT)" $(MOBILE_ANDROID_BUNDLE_ARGS)
