...
submit-ios: build-ios
	...
	@LOOPAWARE_MOBILE_RELEASE_TIMESTAMP="$(MOBILE_RESOLVED_RELEASE_TIMESTAMP)" node "$(MOBILE_IOS_SUBMIT_SCRIPT)" --mobile-dir "$(MOBILE_DIR)" $(MOBILE_IOS_SUBMIT_ARGS)
