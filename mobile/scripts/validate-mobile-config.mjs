...
for (const obsoleteFile of ["mobile/app.json", "mobile/eas.json", "mobile/scripts/publish-android-play.mjs", "mobile/scripts/submit-ios.mjs", "mobile/scripts/build-ios-archive.mjs", "mobile/scripts/build-android-bundle.mjs"]) {
...
assert(packageJSON.dependencies?.expo === "~57.0.20", "mobile_config_expo_patch_version_outdated");
assert(packageJSON.dependencies?.["expo-auth-session"] === "~57.0.11", "mobile_config_auth_session_patch_version_outdated");
assert(packageJSON.dependencies?.["expo-constants"] === "~57.0.17", "mobile_config_constants_patch_version_outdated");
assert(packageJSON.dependencies?.["expo-dev-client"] === "~57.0.18", "mobile_config_dev_client_patch_version_outdated");
assert(packageJSON.dependencies?.["expo-web-browser"] === "~57.0.2", "mobile_config_web_browser_patch_version_outdated");
assert(packageJSON.dependencies?.["react-native"] === "0.86.3", "mobile_config_react_native_sdk_version_incompatible");
assert(
  packageJSON.devDependencies?.["@react-native/metro-config"] === packageJSON.dependencies["react-native"],
  "mobile_config_metro_version_must_match_react_native",
);
assert(
  packageJSON.dependencies?.["react-native-safe-area-context"] === "~5.9.1",
  "mobile_config_safe_area_version_unapproved",
);
