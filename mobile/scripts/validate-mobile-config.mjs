...
assert(packageJSON.dependencies?.expo === "~57.0.15", "mobile_config_expo_patch_version_outdated");
assert(packageJSON.dependencies?.["expo-auth-session"] === "~57.0.8", "mobile_config_auth_session_patch_version_outdated");
assert(packageJSON.dependencies?.["expo-constants"] === "~57.0.13", "mobile_config_constants_patch_version_outdated");
assert(packageJSON.dependencies?.["expo-dev-client"] === "~57.0.14", "mobile_config_dev_client_patch_version_outdated");
assert(packageJSON.dependencies?.["expo-web-browser"] === "~57.0.2", "mobile_config_web_browser_patch_version_outdated");
assert(packageJSON.dependencies?.["react-native"] === "0.86.2", "mobile_config_react_native_sdk_version_incompatible");
assert(
  packageJSON.dependencies?.["react-native-safe-area-context"] === "~5.8.1",
