...
- [ ] [I001] (P1) Consider a design of a current accordion design of different surfaces.
  We may want to have a better split out.
- [x] [I002] (P1) Advertise LA Sentry on the public landing page.
  ### Summary
...
- [x] [I003] (P1) Consolidate LA Sentry client discovery under `clients/`.
  ### Summary
...
- [ ] [I004] (P1) Replace placeholder-only inputs with labeled fields in the static frontend.
  ### Summary
