...
### Improvements
    ...
    - [x] [LA-77] Add a delay to log the user out after 2 minutes. Have a notification row at the bottom, above the footer, that will display: you have been inactive for 1 minute. Log off? Yes, No. It will automatically log off the user in 1 min since the message appearance on the screen. trigger the countdown from the last action of the user.
