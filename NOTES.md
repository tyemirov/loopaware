...
- [ ] [LA-52] Remove the square around the logo for both the landing page and the dashboard. The logo shall be transparent. Increase the size of the logo.
- [ ] [LA-53] Slim down the header and the footer
