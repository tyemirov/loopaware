...
| --- | --- | --- | --- |
| Go | [`clients/go/lasentry`](go/lasentry) | `/sentry/errors` | Protected server-side client. Existing `pkg/lasentry` imports remain supported through a compatibility package. |
