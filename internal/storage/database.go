...
func AutoMigrate(database *gorm.DB) error {
	...
	if err := database.AutoMigrate(&model.Site{}, &model.Feedback{}, &model.User{}, &model.Subscriber{}, &model.SiteVisit{}, &model.SiteVisitRollup{}, &model.TrafficReportSchedule{}, &model.PortfolioTrafficReportSchedule{}, &model.PortfolioTrafficReportDefinition{}, &model.PortfolioTrafficReportDefinitionSite{}, &model.SentryIssue{}, &model.SentryOccurrence{}, &model.SiteMobileApp{}, &model.SiteTeamMember{}, &model.SiteHealthMonitor{}, &model.SiteHealthEvent{}); err != nil {
		return err
	}
