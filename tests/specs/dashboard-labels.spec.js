...
const labelCases = [
  ...
  { selector: '#dashboard-section-tab-health', text: 'Health' },
  ...
  { selector: '#health-monitor-title', text: 'Health' },
  { selector: 'label[for="health-monitor-enabled"]', text: 'Enable health checks' },
  { selector: 'label[for="health-monitor-target-url"]', text: 'Target URL' },
  { selector: 'label[for="health-monitor-interval"]', text: 'Check every' },
  { selector: 'label[for="health-monitor-timeout"]', text: 'Timeout' },
  { selector: 'label[for="health-monitor-threshold"]', text: 'Failure threshold' },
  { selector: 'label[for="health-monitor-recipient"]', text: 'Manager email' },
  { selector: 'label[for="health-monitor-recipient-mode-manager"]', text: 'Only me' },
  { selector: 'label[for="health-monitor-recipient-mode-team"]', text: 'Whole team' },
  { selector: 'label[for="health-monitor-recipient-mode-selected"]', text: 'Selected members' },
  { selector: '#health-monitor-run-check-button', text: 'Run check now' },
